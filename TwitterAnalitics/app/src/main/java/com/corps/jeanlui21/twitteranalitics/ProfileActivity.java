...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void loadUserInformation() {
        ...
        if (user != null) {
            ...
            if(user.isEmailVerified()){
                ...
                textView.setText("Email No Verificado (pulsa aqui para verificar)");
                    ...
                    public void onClick(View view) {
                        user.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                Toast.makeText(ProfileActivity.this, "Correo de Verificación Enviado",Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                });
    ...
    private void showImageChooser() {
        ...
        startActivityForResult(Intent.createChooser(intent, "Selecciona una imagen"), CHOOSE_IMAGE);
    }
}
